...
const Report: React.FC<ReportProps> = ({ marginTop }) => {
  ...
  const loadExpenses = async () => {
    ...
    try {
      ...
      // Hide income transactions if showIncome is false
  ...
  return (
    <IonPage style={{ paddingTop: marginTop }} >
      ...
      <IonContent className="ion-padding" style={{ background: "#f6f8fa" }}>
        ...
        {/* Fixed search bar and total expenses */}
        <div
          style={{
            position: 'sticky',
            top: -70,
        ...
        >
          ...
          >
            <p style={{ margin: 0, marginBottom: 10, fontWeight: 700, color: "#222", fontSize: 18, letterSpacing: 1 }}>
              Today's Total Expenses =

              <span style={{ fontSize: 18, color: "#e53935", fontWeight: 600 }}>
